...
export function ChatView({ serverId, serverName, provider, availableProviders = [], onProviderChange, resumeSessionId, backgroundSessionId, alreadyRunning, onBack, headerless, fileButton }: ChatViewProps) {
  const { messages, status, activeTool, sendMessage, cancelTurn, respondPermission, respondQuestion, setPermissionMode, setEffort, bridgeMode, reconnect, setInitialMessages } = useClaudeChat(
    serverId,
    provider,
    resumeSessionId,
    backgroundSessionId,
